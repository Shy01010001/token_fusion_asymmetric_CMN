...
class AttModel(CaptionModel):
    ...
    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, state, output_logsoftmax=1):
        ...
        xt = self.embed(it) # [batch_size, emd_dim] [bos]
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, opt={}): # [16, 4096], [16, 98, 2048]
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, att_masks) # [16, 4096]
        ...
        # first step, feed bos
        it = fc_feats.new_full([batch_size], self.bos_idx, dtype=torch.long) # [batch_size]
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, update_opts={}):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(fc_feats, att_feats, att_masks, opt) # [16, 4096], [16, 98, 2048]
        if group_size > 1:
        ...
        for t in range(self.max_seq_length + 1):
            ...
            logprobs, state = self.get_logprobs_state(it, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks,
                                                      state, output_logsoftmax=output_logsoftmax)
